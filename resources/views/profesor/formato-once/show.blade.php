            ...
            <div class="flex justify-between items-start">
                ...
                <div class="flex gap-3">
                    ...
                    <a href="{{ route('profesor.formato-once.edit', $formatoOnce->id) }}"
                       class="px-4 py-2 bg-amber-700 text-white rounded-md hover:bg-amber-800 transition-colors duration-200 flex items-center gap-2">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    <caption class="sr-only">Resultados del Formato 11</caption>
